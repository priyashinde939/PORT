...
const ServicesSection: React.FC = () => {
  return (
    <div className="bg-[#0500A6] text-white min-h-screen p-8 flex justify-center items-center">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl w-full">
        <div className="bg-[#FFFFFF] text-[#0500A6] p-8 rounded-lg flex flex-col justify-between">
          ...
          <div className="flex justify-end mt-4">
            <div className="bg-[#DFDFDF] w-12 h-12 flex items-center justify-center rounded-full">
              <span className="text-[#0500A6] text-3xl">+</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#FFFFFF] text-[#0500A6] p-8 rounded-lg md:col-span-2 flex flex-col justify-between">
          <div className="flex items-center">
