...
//https://www.instagram.com/makepill_agency/
function Social() {
    const data = [
        {title: 'Home', link1: '@HolaHola_Portfolio', socLink: '#' },
        {title: 'About', link1: '@HolaHola_Portfolio', socLink: '#about'},
        {title: 'Contact', link1: '@HolaHola_Portfolio', socLink: './contact'},
        {title: 'Projects', link1: '@HolaHola_Portfolio', socLink: './projects'},
